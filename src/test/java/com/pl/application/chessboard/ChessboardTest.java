...
import com.pl.application.chessboard.state.Arrangement;
import com.pl.application.chessboard.state.Move;
import com.pl.application.chessboard.state.StateOfChessboard;
import com.pl.application.chessboard.state.TypeOfCustomMove;
